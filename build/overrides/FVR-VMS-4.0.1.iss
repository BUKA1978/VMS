; ============================================================
; FVR VMS 4.0.1 - Instalador Windows x64
; Banco PostgreSQL dedicado incluído e inicializado automaticamente.
; ============================================================
...
Filename: "sc.exe"; Parameters: "config ""FVR Management Server"" binPath= """"{app}\ManagementServer\FVR.ManagementServer.exe"""" start= auto"; Flags: runhidden; Components: mgmt
...
Filename: "sc.exe"; Parameters: "config ""FVR Recording Server"" binPath= """"{app}\RecordingServer\FVR.RecordingServer.exe"""" start= auto"; Flags: runhidden; Components: recorder
...
[Messages]
WelcomeLabel1=Instalação do FVR VMS 4.0.1
WelcomeLabel2=Esta versão configura automaticamente o PostgreSQL dedicado, cria o banco fvr_vms, aplica o schema, inicia os serviços e cria o administrador inicial.%n%nPara uma instalação completa, selecione Management Server, Recording Server e Monitoring Client.
FinishedLabel=Instalação concluída.%n%nAcesso inicial do Monitoring Client:%nUsuário: admin%nSenha: FVR@2026!%n%nServidor local: http://localhost:5000%n%nO PostgreSQL do FVR VMS usa somente 127.0.0.1:55432 e não é exposto na rede.
